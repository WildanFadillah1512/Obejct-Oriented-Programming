...
class SavingsAccount(BankAccount):
    ...
    def withdraw(self, amount, pin):
        if amount > self.WITHDRAW_LIMIT:
            print(f"Withdrawal limit exceeded! Maximum allowed: ${self.WITHDRAW_LIMIT}")
        else:
...
while True:
    ...
    print("3. Create Premium Savings Account")
    ...
    if choice == "1":
        ...
        if BankAccount.logged_in_account:
            while True:
                ...
                if transaction_choice == "1":
                    ...
                    print(f"Account Holder: {BankAccount.logged_in_account.account_holder}")
                    print(f"Current Balance: ${BankAccount.logged_in_account._balance}")
        ...
        SavingsAccount(name, initial_balance, pin)
        print("Savings Account created successfully!")
    elif choice == "3":
        name = input("Enter account holder's name: ")
        initial_balance = get_valid_number("Enter initial deposit amount: ")
        pin = input("Set a PIN for the account: ")
        PremiumSavingsAccount(name, initial_balance, pin)
        print("Premium Savings Account created successfully!")
    elif choice == "4":
